...
it_product_model = genai.GenerativeModel("gemini-1.5-flash",
                                         system_instruction="""
...
# Upload an image
product_image = st.file_uploader("Upload a picture of an IT product",
                                 type=["jpg", "jpeg", "png"])

if product_image is not None:
    # Open and display the uploaded image
    img = PILImage.open(product_image)
    img.thumbnail((400, 200))  # Resize the image to max 800x800 pixels
